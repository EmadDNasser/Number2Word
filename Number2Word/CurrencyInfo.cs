...
namespace Number2Word
{
    public class CurrencyInfo
    {
        ...
        public enum Currencies { SYP = 0, USD, EUR };
        ...
        public CurrencyInfo(Currencies currency)
        {
            switch (currency)
            {
                ...
                case Currencies.USD:
                    ...
                    //EnglishCurrencyName = "USA Dollar";
                    //EnglishPluralCurrencyName = "USA Dollars";
                    ...
                    CurrencyCode = "USD";
                    IsCurrencyNameFeminine = false;
                    EnglishCurrencyName = "Dollars";
                    EnglishPluralCurrencyName = "Dollars";
                    EnglishCurrencyPartName = "Cent";
                    EnglishPluralCurrencyPartName = "Cents";
                    Arabic1CurrencyName = "دولاراً";
